            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 py-3">
                    <div class="card-blog">
                        ...
                        <div class="body">
                            <div class="post-title"><a href="blog-single.html">Bagaimana cara megolah sampah anorganik?</a></div>
                            <div class="post-excerpt">Sampah atau limbah anorganik adalah sampah yang...</div>
                        </div>
                        <div class="footer">
                            <a class="text-success" href="/blog-single">Read More <span class="mai-chevron-forward text-sm"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 py-3">
                ...
                <div class="col-12 mt-5">
                    <nav aria-label="Page Navigation">
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item"><a class="page-link test text-white" href="#">1</a></li>
